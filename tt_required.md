 ...
 ### 1.3用語定義
  ...
  |2.1.9|戦績情報の登録|対戦結果を記録するため。|戦績ID、大会名、選手、対戦日、ゲームカウント、対戦位置、利用者IDを戦績情報（record）として登録する。<br>選手は1人ずつ登録し、それぞれが点数を持つようにする。<br>対戦日はdate型。<br>ゲームカウントは2桁まで。<br>対戦位置は15文字以内。|
