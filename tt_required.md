 ...
 ### 1.3用語定義
  ...
  |2.1.8|選手の登録|選手の情報を記録するため。|選手名、選手ID、性別、戦型、ラバーの種類、利用者IDを選手情報（player）として登録する。<br>選手名は15文字以内。<br>性別は「男」「女」の2種類から選択する。<br>戦型は「ドライブ型」「前人即効型」「カットマン」「ショートマン」「その他」の5種類から選択する。<br>ラバーの種類は20文字以内。|
